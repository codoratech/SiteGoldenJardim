            ...
            <tbody class="divide-y divide-white/5 text-sm">
                ...
                <tr class="hover:bg-white/5 transition-colors">
                    ...
                    <td class="p-4 text-center space-x-2">
                        ...
                        <a href="produtos.php?acao=excluir&id=<?= $row['ID_Produto'] ?>" class="text-red-400 hover:underline text-xs" data-confirm-msg="Tem certeza que deseja excluir este produto?">Excluir</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            </tbody>
